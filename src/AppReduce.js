  ...
  return (
    ...
    <div className="App">
      ...
      <div className="todo-wrapper">
        ...
        <TodoList isCompleteScreen={isCompleteScreen} handleDeleteTodo={handleDeleteTodo} handleComplete={handleComplete} handleDeleteCompleteTodo={handleDeleteCompleteTodo} ></TodoList>
